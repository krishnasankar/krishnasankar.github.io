...
- 🍂 **Interactive Skills Gravity Collapse**: Hovering over any of the skills boxes triggers a real physics gravity collapse, causing the skill tiles to tumble and bounce into the box's bottom boundary, springing back magnetically when the mouse leaves.
